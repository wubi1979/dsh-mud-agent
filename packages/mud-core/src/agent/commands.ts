 ...
 * `src/agent/skills.ts` 的 MudSkill)。命令与技能的判定:
 ...
 *     闸门 (`agent/gate/policy.ts`) 再做档位感知的 `deny`/`ask`。
 * @module @deepseek-ai/dsh-mud-core/agent/commands
 */

import type { MudTier } from './gate/tiers.ts'
