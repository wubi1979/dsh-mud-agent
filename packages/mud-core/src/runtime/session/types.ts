/**
 * dsh-mud-core — 会话运行时类型与纯函数 (runtime/session/types).
 *
 ...
 * @module @deepseek-ai/dsh-mud-core/runtime/session/types
 */
 ...
 * @deprecated 由 `runtime/flow/flows.ts` 的 `LOGIN_FLOW` 声明取代（`doc/ARCHITECTURE.md` §11/§19）。
 */
