...
import { Perceptor, type PerceptHit } from '../src/triggers.ts'
import { StyleFlag, type ParsedLine, type StyleRun } from '../src/ansi.ts'
import { PerceptionBuffer, type MudLine } from '../src/perception.ts'
